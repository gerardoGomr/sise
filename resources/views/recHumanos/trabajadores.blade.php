...
@section('css')
    <link rel="stylesheet" type="text/css" href="/assets/components/modules/admin/modals/assets/js/source/jquery.fancybox.css">
@stop
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="col-separator col-unscrollable box col-separator-first">
                            <div class="heading-buttons border-bottom innerLR">
                                ...
                                <a href="{{ url('/rHumanos/captura') }}" class="btn btn-xs btn-primary pull-right"><i class="fa fa-plus"></i> Agregar trabajador<i class="fa fa-user fa-fw"></i></a>
                                ...
                                <div class="col-table-row">
                                    <div class="col-app col-unscrollable">
                                        <div class="col-app">
                                            ...
                                            <input type="hidden" id="urlClickTrabajador" value="{{ url('rHumanos/detalle') }}">
                                            <ul id="listaTrabajadores" class="list-group list-group-1 borders-none">
                                                @include('recHumanos.trabajadoresLista')
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
@section('js')
    <script type="text/javascript" src="/assets/components/modules/admin/modals/assets/js/source/jquery.fancybox.js"></script>
    <script type="text/javascript" src="/js/ajax.js"></script>
    <script type="text/javascript" src="/js/rHumanos/trabajadores.js"></script>
@stop