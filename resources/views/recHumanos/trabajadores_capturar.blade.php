										...
										<div class="col-app">
											<div class="innerAll">
												...
												<div class="box-generic">
					                            	...
					                            	<div class="dvFoto">
					                            		<input type="hidden" id="urlFotoRecortada" value="{{ url('recHumanos/recortarFoto') }}">
					                            		<span id="fotografia">
					                            			@include('recHumanos.trabajadores_foto')
					                            		</span>
					                            		<div class="separator"></div>
					                            		{!! Form::open(['url' => url('recHumanos/subirFoto'), 'id' => 'formSubirImagen', 'enctype' => 'multipart/form-data']) !!}
							...
							<div class="col-table">
								...
								<div class="col-table-row">
									<div class="col-app col-unscrollable">
										<div class="col-app">
											<div class="innerAll">
												{!! Form::open(['url' => url('recHumanos/guardarTrabajador'), 'id' => 'formTrabajadores']) !!}
													@if(isset($trabajador))
														@include('recHumanos.trabajadores_editar')
													@else
														@include('recHumanos.trabajadores_agregar')
													@endif
												{!! Form::close() !!}
											</div>
										</div>
...
@section('js')
	...
	<script type="text/javascript" src="{{ asset('public/js/recHumanos/trabajadores_capturar.js') }}"></script>
@stop