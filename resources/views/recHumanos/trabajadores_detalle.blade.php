<div class="innerAll">
	<div class="media border-bottom">
		...
		@else
			<img src="{{ asset('public/img/default_user.png') }}" class="thumb pull-left" alt="" width="100">
		@endif
		...
		<a href="{{ url('recHumanos/edicion/'.base64_encode($trabajador->getId())) }}" class="btn btn-info btn-sm"><i class="fa fa-fw fa-edit"></i> Editar datos</a>

		@if($trabajador->tieneCuenta())
			@if($trabajador->activo())
				<a href="{{ url('recHumanos/password/'.base64_encode($trabajador->getId())) }}" class="btn btn-info btn-sm cambiarPassword" data-fancybox-type="iframe"><i class="fa fa-fw fa-key"></i> Cambiar contraseña</a>

				<a href="{{ url('recHumanos/desactivar') }}" class="btn btn-info btn-sm desactivar"><i class="fa fa-fw fa-ban"></i> Desactivar usuario</a>
			@else
				<a href="{{ url('recHumanos/activar') }}" class="btn btn-info btn-sm activar"><i class="fa fa-fw fa-check-circle"></i> Activar usuario</a>
			@endif
