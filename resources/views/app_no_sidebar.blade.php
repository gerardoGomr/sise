...
<html class="app footer-sticky"><!-- <![endif]-->
	...
	<body class="scripts-async loginWrapper">
					...
					<div class="row row-app">
						<div class="col-md-12">
							<div class="col-separator col-unscrollable box">
								<h4 class="innerAll bg-gray text-center"><i class="fa fa-lock"></i> Sistema Integral de Seguimiento de Evaluaciones</h4>
								<div class="col-table">
		...
		<script type="text/javascript" src="{{ asset('public/assets/components/core/js/sidebar.discover.init.js?v=v1.9.6') }}"></script>
